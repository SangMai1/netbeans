...
//    }
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        // TODO add your handling code here:
        if (nvdao.del(txtMaNhanVien.getText()) > 0) {
            fillData();
        }
...
//        NhanVien ee = nvdao.getNhanVienById(rowData);
//        setModel(ee);
        txtMaNhanVien.setText(tbTable.getValueAt(rowData, 0).toString());
        txtTenNhanVien.setText(tbTable.getValueAt(rowData, 1).toString());
        txtNgaySinh.setText(tbTable.getValueAt(rowData, 2).toString());
        if (tbTable.getValueAt(rowData, 3).toString().equalsIgnoreCase("Nam")) {
            rdNam.setSelected(true);
        } else {
            rdNu.setSelected(true);
        }
        cboPhongBan.setSelectedItem(tbTable.getValueAt(rowData, 4).toString());
