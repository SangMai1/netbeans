 ...
 * @author SANG
 */
public class FrCaculation extends javax.swing.JFrame {
    double num, ans;
    int caculator;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrCaculation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrCaculation().setVisible(true);
            }
        });
    }
