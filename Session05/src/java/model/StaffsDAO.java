...
public class StaffsDAO {
    ...
    public int update(Staffs sta){
        ...
        try {
            ...
            conn = DatabaseUtils.getDBConnect();
            sttm = conn.prepareStatement(sSQL);
            sttm.setString(10, sta.getId());
            sttm.setString(1, DateHelper.toString(sta.getBirthday()));
            sttm.setString(2, sta.getEmail());
            sttm.setBoolean(3, sta.isGender());
            sttm.setString(4, sta.getName());
            sttm.setString(5, sta.getNotes());
            sttm.setString(6, sta.getPhone());
            sttm.setString(7, sta.getPhoto());
            sttm.setFloat(8, sta.getSalary());
            sttm.setString(9, sta.getDepart_id().getId());
            if (sttm.executeUpdate() > 0) {
